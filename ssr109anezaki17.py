...
#左へ向かせたい
      ...
      #center_xeight=center_x*0.8
      
      mr = ((cpx_left / center_x*0.8)*95) + 10    #ズレを中心の座標で割る．その後にモーターの出力をかける．

      time.sleep(0.1)
      csv.run(mr)
      #print(" center_x*0.8 = %6.2f " %center_xeight)
      #print(" cpxleft = %6.2f " %cpx_left)
...
#右へ向かせたい
      ...
      mr = - ( ((cpx/maxpix)*70) + 2)             #motor run  モーター出力 
