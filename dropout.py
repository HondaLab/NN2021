...
input_test = input_data[index_train, :] 
...
middle_layer_2 = MiddleLayer(n_in, n_mid)
...
def forward_propagation(x, is_train):
    ...
    dropout_2.forward(middle_layer_1.y, is_train)
    output_layer.forward(dropout_2.y)
    
def backpropagation(t):
    output_layer.forward(t)
...
for i in range(epoch):
    ...
    error_test = get_error(correct_train, n_test)
